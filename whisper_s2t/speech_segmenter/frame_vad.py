...
class FrameVAD(VADBaseClass):
    def __init__(self, 
        ...
        if self.device == 'cpu':
            # This is a JIT Scripted dto of Nvidia's NeMo Framewise Marblenet Model: https://catalog.ngc.nvidia.com/orgs/nvidia/teams/nemo/models/vad_multilingual_frame_marblenet
